...
var author$project$Api$words = function (message) {
	return elm$http$Http$get(
		{
			expect: A2(elm$http$Http$expectJson, message, author$project$Api$wordsDecoder),
			url: 'words.json'
		});
};
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		author$project$Main$Home(elm$core$Maybe$Nothing),
...
var author$project$Main$RandomWord = F2(
	function (a, b) {
...
var author$project$Main$generateRandomWord = F2(
	function (head, tail) {
		return A2(
			elm$random$Random$generate,
...
var author$project$Main$initialSoloModel = F2(
	function (word, _n0) {
		var head = _n0.a;
		var tail = _n0.b;
		return {
			...
			switch (_n0.a.$) {
						...
						case 'OnClickSolo':
							...
							if (words.$ === 'Just') {
								...
								if (!list.b) {
									...
									return _Utils_Tuple2(
										page,
										A2(author$project$Main$generateRandomWord, head, tail));
								}
							} else {
								return _Utils_Tuple2(page, elm$core$Platform$Cmd$none);
							}
						case 'RandomWord':
							...
							return _Utils_Tuple2(
								author$project$Main$Game(
									A2(
										author$project$Main$initialSoloModel,
										word,
										_Utils_Tuple2(head, tail))),
								elm$core$Platform$Cmd$none);
						case 'OnClickInput':
				...
				case 'Input':
					switch (_n0.b.$) {
						case 'OnInput':
							var input = _n0.b.a;
							var _n9 = author$project$Main$isInputGood(input);
							if (_n9.$ === 'Just') {
								var validString = _n9.a;
								return _Utils_Tuple2(
				...
				default:
					switch (_n0.b.$) {
						...
						case 'OnKeyPressed':
							var model = _n0.a.a;
							var _char = _n0.b.a;
							var _n11 = author$project$Main$state(model);
							if (_n11.$ === 'Playing') {
								return _Utils_Tuple2(
									author$project$Main$Game(
										A2(author$project$Main$updateModel, model, _char)),
...
var author$project$Main$buttonReplay = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$Events$onClick(author$project$Main$OnClickReplay),
					rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[
							rtfeldman$elm_css$Css$color(
							A3(rtfeldman$elm_css$Css$rgb, 255, 255, 255)),
							rtfeldman$elm_css$Css$backgroundColor(
							A3(rtfeldman$elm_css$Css$rgb, 255, 51, 51)),
							rtfeldman$elm_css$Css$borderRadius(
							rtfeldman$elm_css$Css$px(7)),
							A2(
							rtfeldman$elm_css$Css$padding2,
			...
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$text('Rejouer !')
				]))
		]));
...
var author$project$Main$isSoloDisabled = function (words) {
	if (words.$ === 'Just') {
		var list = words.a;
		if (!list.b) {
			return true;
...
var author$project$Main$OnClickKey = function (a) {
	return {$: 'OnClickKey', a: a};
};
...
var author$project$Main$key = F2(
	function (_char, isDisabled) {
		return A2(
			rtfeldman$elm_css$Html$Styled$button,
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$Events$onClick(
					author$project$Main$OnClickKey(_char)),
					rtfeldman$elm_css$Html$Styled$Attributes$css(
					_List_fromArray(
						[
...
var author$project$Main$keyboard = function (triedChars) {
	return A2(
		rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				...
				A2(
					...
					function (c) {
						return A2(
							...
							c,
							A2(elm$core$List$member, c, triedChars));
					},
					A2(
						elm$core$List$map,
						elm$core$Char$fromCode,
						A2(elm$core$List$range, 65, 77)))),
				A2(
				rtfeldman$elm_css$Html$Styled$div,
				_List_Nil,
				A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										author$project$Main$isSoloDisabled(words))
									]),
								_List_fromArray(
									[
